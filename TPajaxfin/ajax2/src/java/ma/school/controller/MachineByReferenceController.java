...
public class MachineByReferenceController extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    List<Machine> machines = mms.findByReference(reference);

    // Stocker les résultats dans l'attribut de la requête
    request.setAttribute("filteredMachines", machines);

    // Rediriger vers la page JSP appropriée pour afficher les résultats
    request.getRequestDispatcher("votre_page_jsp.jsp").forward(request, response);
}
