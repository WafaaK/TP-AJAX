                ...
                <table border="1" class="tab">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=e.getSexe()%></td>
                            <td><a class="bndelete" href="EtudiantController?op=delete&id=<%=e.getId()%>" onclick="return confirm('Voulez-vous vraiment supprimer cet étudiant ?')">Supprimer</a></td>
                            <td><a class="bnupdate" href="etudiantUpdate.jsp?id=<%= e.getId() %>">Modifier</a></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
